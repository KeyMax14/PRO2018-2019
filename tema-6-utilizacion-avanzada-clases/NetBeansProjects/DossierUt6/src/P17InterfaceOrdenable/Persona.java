...
public abstract class Persona implements Ordenable<Persona>{
    ...
    public String toString() {
        ...
        @Override
    public boolean esMayorQue(P17InterfaceOrdenable.Persona elemento) {
        return this.edad > elemento.edad;
    }

    @Override
    public boolean esMenorQue(P17InterfaceOrdenable.Persona elemento) {
        return this.edad < elemento.edad;
    }

    @Override
    public boolean esIgualQue(P17InterfaceOrdenable.Persona elemento) {
        return this.edad < elemento.edad;
    }
