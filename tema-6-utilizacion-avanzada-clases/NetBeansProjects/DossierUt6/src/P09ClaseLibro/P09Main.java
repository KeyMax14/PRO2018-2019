...
public class P09Main {
    public static void main(String[] args) {
        String autores[] = {"Jose","Andres"};
        
        VolumenLibro libro = new VolumenLibro(0, autores, "El pajaro azul",
        "Un pajaro azul vive en una rama.", 600, "Juan", EstadoConservacion.BUENO);
