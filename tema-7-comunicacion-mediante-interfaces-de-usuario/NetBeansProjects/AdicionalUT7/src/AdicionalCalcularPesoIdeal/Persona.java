...
public abstract class Persona implements Ordenable<Persona>{
    ...
    public Persona(String nombre, String apellido1, int edad, int altura, double peso) {
        this.nombre = nombre;
    ...
    public String toString() {
        ...
        return nombre + " " + apellido1 + ", Edad:" + edad + " años, Altura:" + altura + " cm, Peso:" + peso + " IMC: "+ imc;
    }
